...
tools: Read, Grep, Glob, Write(telemetry/**), Write(deliverables/RTM*.md), Write(deliverables/WEEKLY*.md), Write(deliverables/CASE-STUDY*.md), Write(deliverables/HEALTH-CHECK*.md)
model: sonnet
---
